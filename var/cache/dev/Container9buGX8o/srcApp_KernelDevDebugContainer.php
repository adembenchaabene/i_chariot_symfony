...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('0L9ZSTtJKS', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Y6CbNtaPBA', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('M1mbS2hnfX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VJ7I3lbqJ5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BSuGlrFDYI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qKOpXPoJU2', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ctFn12e32Q', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderaa0bf = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer4eb82 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties69c29 = [
        
    ];

    public function getConnection()
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'getConnection', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'getMetadataFactory', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'getExpressionBuilder', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'beginTransaction', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'getCache', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->getCache();
    }

    public function transactional($func)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'transactional', array('func' => $func), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'wrapInTransaction', array('func' => $func), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'commit', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->commit();
    }

    public function rollback()
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'rollback', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'getClassMetadata', array('className' => $className), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'createQuery', array('dql' => $dql), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'createNamedQuery', array('name' => $name), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'createQueryBuilder', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'flush', array('entity' => $entity), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'clear', array('entityName' => $entityName), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->clear($entityName);
    }

    public function close()
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'close', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->close();
    }

    public function persist($entity)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'persist', array('entity' => $entity), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'remove', array('entity' => $entity), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'refresh', array('entity' => $entity), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'detach', array('entity' => $entity), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'merge', array('entity' => $entity), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'getRepository', array('entityName' => $entityName), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'contains', array('entity' => $entity), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'getEventManager', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'getConfiguration', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'isOpen', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'getUnitOfWork', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'getProxyFactory', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'initializeObject', array('obj' => $obj), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'getFilters', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'isFiltersStateClean', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'hasFilters', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return $this->valueHolderaa0bf->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer4eb82 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderaa0bf) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderaa0bf = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderaa0bf->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, '__get', ['name' => $name], $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        if (isset(self::$publicProperties69c29[$name])) {
            return $this->valueHolderaa0bf->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderaa0bf;
    ...
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;
    ...
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, '__isset', array('name' => $name), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;
    ...
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, '__unset', array('name' => $name), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;
    ...
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, '__clone', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        $this->valueHolderaa0bf = clone $this->valueHolderaa0bf;
    }

    public function __sleep()
    {
        $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, '__sleep', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;

        return array('valueHolderaa0bf');
    }
    ...
    {
        $this->initializer4eb82 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer4eb82;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer4eb82 && ($this->initializer4eb82->__invoke($valueHolderaa0bf, $this, 'initializeProxy', array(), $this->initializer4eb82) || 1) && $this->valueHolderaa0bf = $valueHolderaa0bf;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderaa0bf;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderaa0bf;
    }
}
