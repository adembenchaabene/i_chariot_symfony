...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('P+uxmMZFQv', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vGCTTWN54t', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-7RoLFu2em', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mEne9OdsqZ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('V8altFh1Z4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('N52PEF6YtA', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PHGqBt35z6', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder2ff6d = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer9b11b = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesf9376 = [
        
    ];

    public function getConnection()
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'getConnection', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'getMetadataFactory', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'getExpressionBuilder', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'beginTransaction', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'getCache', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->getCache();
    }

    public function transactional($func)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'transactional', array('func' => $func), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'wrapInTransaction', array('func' => $func), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'commit', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->commit();
    }

    public function rollback()
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'rollback', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'getClassMetadata', array('className' => $className), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'createQuery', array('dql' => $dql), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'createNamedQuery', array('name' => $name), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'createQueryBuilder', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'flush', array('entity' => $entity), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'clear', array('entityName' => $entityName), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->clear($entityName);
    }

    public function close()
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'close', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->close();
    }

    public function persist($entity)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'persist', array('entity' => $entity), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'remove', array('entity' => $entity), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'refresh', array('entity' => $entity), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'detach', array('entity' => $entity), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'merge', array('entity' => $entity), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'getRepository', array('entityName' => $entityName), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'contains', array('entity' => $entity), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'getEventManager', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'getConfiguration', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'isOpen', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'getUnitOfWork', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'getProxyFactory', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'initializeObject', array('obj' => $obj), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'getFilters', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'isFiltersStateClean', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'hasFilters', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return $this->valueHolder2ff6d->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer9b11b = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder2ff6d) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder2ff6d = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder2ff6d->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, '__get', ['name' => $name], $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        if (isset(self::$publicPropertiesf9376[$name])) {
            return $this->valueHolder2ff6d->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder2ff6d;
    ...
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;
    ...
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, '__isset', array('name' => $name), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;
    ...
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, '__unset', array('name' => $name), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;
    ...
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, '__clone', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        $this->valueHolder2ff6d = clone $this->valueHolder2ff6d;
    }

    public function __sleep()
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, '__sleep', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        return array('valueHolder2ff6d');
    }
    ...
    {
        $this->initializer9b11b = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer9b11b;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'initializeProxy', array(), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder2ff6d;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder2ff6d;
    }
}
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer9b11b && ($this->initializer9b11b->__invoke($valueHolder2ff6d, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer9b11b) || 1) && $this->valueHolder2ff6d = $valueHolder2ff6d;

        if ($this->valueHolder2ff6d === $returnValue = $this->valueHolder2ff6d->paginate($target, $page, $limit, $options)) {
            return $this;
        }
